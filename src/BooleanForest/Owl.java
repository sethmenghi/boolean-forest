...
public class Owl {
	// Public static final members of Owl class are Strings that
	public static final String BOB = "BOB";			// 158 x 159
	public static final String ALICE = "ALICE";		// 158 x 159
	public static final String CHLOE = "CHLOE";		// 106 x 107
	public static final String DAVID = "DAVID";		// 106 x 107
